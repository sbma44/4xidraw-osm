...
RUN apt-get update -y && \
    ...
    apt-get install -y postgresql-9.6 postgresql-client-9.6 postgresql-contrib-9.6 postgresql-plpython-9.6 postgresql-9.6-postgis-scripts postgresql-common postgresql-client-common postgis=2.3.1+dfsg-1.pgdg14.04+1 && \
